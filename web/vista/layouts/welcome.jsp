        ...
        <div class="relative flex flex-col min-h-screen">
            ...
            <main class="flex-grow">
                <div class="max-w-7xl mx-auto p-6 lg:p-8 mt-6">
                    ...
                    <div class="max-w-7xl mx-auto p-6 lg:p-8 mt-6">
                        <form action="buscar" method="get" class="flex items-center border rounded-lg overflow-hidden mb-8 mt-6">
                            <input type="text" name="titulo" placeholder="Buscar..." class="px-4 py-2 flex-1 outline-none">
                        ...
                        <c:if test="${termino != null && !termino.isEmpty()}">
                            <h1 class="text-2xl font-semibold mb-6">Resultados para: "<%= termino%>"</h1>
                            <c:choose>
                        ...
                        <h1 class="text-2xl font-semibold mt-8 mb-6">Todas las Publicaciones</h1>
                        <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
